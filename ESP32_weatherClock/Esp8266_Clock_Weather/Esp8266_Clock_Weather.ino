...
void setup() {
  ...
  configTime(TZ_SEC, DST_SEC, "ntp.ntsc.ac.cn", "pool.ntp.org"); //ntp获取时间，你也可用其他"pool.ntp.org","0.cn.pool.ntp.org","1.cn.pool.ntp.org","ntp1.aliyun.com"
  delay(200);
...
void updateData(OLEDDisplay *display) {  //天气更新
  HeFengClient.doUpdateCurr(&currentWeather, HEFENG_KEY, Lat, Lon);
  HeFengClient.doUpdateFore(foreWeather, HEFENG_KEY, Lat, Lon);
