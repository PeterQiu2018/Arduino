...
int potAnalogPin = 1;  // The Potentiometer is connected to analog 0
...
float LuT_1_xElements[] = { 185, 192, 201, 208, 212, 221, 231, 237, 252, 267, 279, 293, 311, 332, 349, 370, 395, 428, 467, 501, 549, 601, 642, 651};
float LuT_1_yElements[] = { 300, 290, 280, 270, 260, 250, 240, 230, 220, 210, 200, 190, 180, 170, 160, 150, 140, 130, 120, 110, 100, 90, 80, 70};
...
void setup() {
  ...
  Serial.println(sizeof(LuT_1_xElements[0]));
...
void CheckLuTArrays(float xArraySize, float yArraySize, float xElements[], float yElements[]) {
  ...
  if (xArraySize != yArraySize) {  // check for array size missmatch
    ...
    while (1)
      ;  // Hold the execution at this point
  }
